...
public class UpdatePower extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Powers> list = dao.find("select * from Powers where PowerId= "+powerId);
		Powers power = list.get(0);
		HttpSession session = request.getSession();
		session.setAttribute("alterpower", power);
		System.out.println(powerId);
		response.sendRedirect("power_update.jsp");
	}
