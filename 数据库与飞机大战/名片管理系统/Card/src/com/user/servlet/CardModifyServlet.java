...
public class CardModifyServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("cardmodifyservlet"+departmentname);
		...
		request.getRequestDispatcher("cardmanage/modicifiedcard.jsp").forward(request, response);
