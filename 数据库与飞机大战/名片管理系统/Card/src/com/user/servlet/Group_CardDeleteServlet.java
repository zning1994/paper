...
public class Group_CardDeleteServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Group_CardDeleteServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect("Group_CardServlet.action?self=1");
	}
