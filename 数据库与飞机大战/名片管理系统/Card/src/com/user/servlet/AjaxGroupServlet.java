...
public class AjaxGroupServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AjaxGroupServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select * from groups,users_position where groups.usersId=users_position.usersId and groupname='" + group+ "' and users_position.usersId not in ("+un+")");
			if (rs.next()) {
