											...
											<td width="60">
												<table width="90%" border="0" cellpadding="0"
													...
													<tr>
														<td class="STYLE1">
															<div align="center">
																<img src="images/select.png" width="14" height="14" onClick="Select()" />
															</div>
														</td>
														<td class="STYLE1">
															<div align="center" onClick="Select()">
																查询
															</div>
														</td>
													</tr>
									...
									<table width="352" height="20" border="0" cellpadding="0"
										...
										<tr>
											<td width="62" height="22" valign="middle">
												<div align="right">
													<a href="LogServlet.action?all=1&&pageNow=1"><img
											...
											<td width="50" height="22" valign="middle">
												<div align="right">
													<a
														href="LogServlet.action?all=1&&pageNow=<%=(Integer)session.getAttribute("pageNow")-1 %>"><img
											...
											<td width="49" height="22" valign="middle">
												<div align="right">
													<a
														href="LogServlet.action?all=1&&pageNow=<%=session.getAttribute("number") %>"><img
