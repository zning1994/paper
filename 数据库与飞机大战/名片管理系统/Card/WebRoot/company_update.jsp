...
-->
  ...
  <body>
   <div id="right_font"><img src="images/main_14.gif"/> 您现在所在的位置：首页 →企业管理 →修改公司 信息</div>
   <%
       Company com = (Company)session.getAttribute("altercompany");
    %>
   <form action="CompanyAlterServlet.action" method="post" onSubmit="return Check()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th  align="center"><p class="STYLE8">修改公司信息</p>
    </th>
  </tr>
  <tr>
    <td><table width="52%" height="322" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9" align="center">
     <input type="text" name="companyId"  style="display:none"  value="<%=com.getCompanyId() %>"/>
        <td width="25%" height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公司名称</span></div></td>
          <td width="68%" height="22" bgcolor="#FFFFFF"><input type="text" name="companyname"  id="companyname" class="STYLE2" value="<%=com.getCompanyName() %>" onBlur="checkName()"/>
         <span id="companynameerror"></span>
        </tr>
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公司地址</span></div></td>
        <td height="22" bgcolor="#FFFFFF"><input type="text" name="address" id="address1"  class="STYLE2" value="<%=com.getAddress() %>" onBlur="checkAddress()"/>
        <span id="companyaddresserror"></span>      </tr>
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公司电话</span></div></td>
        <td height="22" bgcolor="#FFFFFF"><input type="text" name="tel" id="tel" class="STYLE2" value="<%=com.getTel() %>" onBlur="checkTel()"/>
        <span id="companytelerror"></span>      </tr>
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公司传真</span></div></td>
        <td height="22" bgcolor="#FFFFFF"><input type="text" name="fax"  id="fax" class="STYLE2" value="<%=com.getFax() %>" onBlur="checkFax()"/>
        <span id="companyfaxerror"></span>      </tr>
     <tr>
        <td height="22" align="center" bgcolor="#FFFFFF" colspan="2"><div align="center">
          <p align="center">
            <input type="submit"  name="修改"  value="修改" class="button"/>
...
<%session.removeAttribute("altercompany"); %>
</form>
  </body>
</html>
