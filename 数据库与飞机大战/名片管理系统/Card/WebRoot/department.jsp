					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
						  ...
						  <td width="20%" height="22" bgcolor="#FFFFFF">
							...
							<td width="25%" height="22" bgcolor="#FFFFFF">
								<div align="center">
									...
									<table width="352" height="20" border="0" cellpadding="0"
										...
										<tr>
											<td width="62" height="22" valign="middle">
												<div align="right">
													<a href="DepartmentSelectServlet.action?all=1&&pageNow=1"><img
											...
											<td width="50" height="22" valign="middle">
												<div align="right">
													<a
														href="DepartmentSelectServlet.action?all=1&&pageNow=<%=(Integer)session.getAttribute("pageNow")-1 %>"><img
											...
											<td width="49" height="22" valign="middle">
												<div align="right">
													<a
														href="DepartmentSelectServlet.action?all=1&&pageNow=<%=session.getAttribute("number") %>"><img
