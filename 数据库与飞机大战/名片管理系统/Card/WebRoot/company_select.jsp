...
<html>
	...
	-->
		...
		<script type="text/javascript" language="javascript"
			src="js/company.js" charset="gbk"></script>
		<style type="text/css">
<!--
.STYLE1 {
	font-size: 12px
...
-->
	...
	<body>
		<div id="right_font">
			...
			您现在所在的位置：首页   → 企业管理   →
			<strong>企业信息查询</strong>
		</div>
		<form action="CompanySelectServlet.action?all=0" method="post">
		...
		<form action="DeleteCompany.action" method="post"
			name="formcompany">
			<%
												...
												<td width="52">
													<table width="88%" border="0" cellpadding="0"
														...
														<tr>
															<td class="STYLE1">
																<div align="center">
																	<img src="images/083.gif" width="14" height="14" onClick="Delete()"/>
																</div>
															</td>
															<td class="STYLE1">
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td width="24%" height="22" bgcolor="#FFFFFF">
									<div align="center">
										<strong><span class="STYLE1">地址</span>
										</strong>
									</div>
								</td>
								<td width="17%" height="22" bgcolor="#FFFFFF">
									<div align="center">
										<strong><span class="STYLE1">联系方式</span>
										</strong>
									</div>
								</td>
								<td width="14%" height="22" bgcolor="#FFFFFF">
									<div align="center">
										<strong><span class="STYLE1">传真</span>
										</strong>
									</div>
								</td>
								<td width="13%" height="22" bgcolor="#FFFFFF">
									<div align="center">
									...
									<table width="352" height="20" border="0" cellpadding="0"
										...
										<tr>
											<td width="62" height="22" valign="middle">
												<div align="right">
													<a href="CompanySelectServlet.action?all=0&&pageNow=1"><img
											...
											<td width="50" height="22" valign="middle">
												<div align="right">
													<a
														href="CompanySelectServlet.action?all=0&&pageNow=<%=(Integer)session.getAttribute("pageNow")-1 %>"><img
											...
											<td width="49" height="22" valign="middle">
												<div align="right">
													<a
														href="CompanySelectServlet.action?all=0&&pageNow=<%=session.getAttribute("number") %>"><img
