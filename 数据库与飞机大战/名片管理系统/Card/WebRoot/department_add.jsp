...
-->
  ...
  <body>
   <div id="right_font"><img src="images/main_14.gif"/> 您现在所在的位置：首页 →部门管理 →添加新部门 </div>
   <form action="DepartmentAddServlet.action" method="post" onSubmit="return Check()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th  align="center"><p class="STYLE8">添加部门</p>
    </th>
  </tr>
  <tr>
    <td><table width="52%" height="245" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9" align="center">
        ...
        <td height="50" bgcolor="#FFFFFF"> <input type="text" name="departmentname" id="departmentname" class="STYLE2" onblur="checkName()"/>
          <span id="departmentnameerror"></span>
          </tr>
      <tr>
        <td height="50" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">联系电话</span></div></td>
        <td height="50" bgcolor="#FFFFFF"><input type="text" name="tel" id="tel" class="STYLE2" onblur="checkTel()"/>
