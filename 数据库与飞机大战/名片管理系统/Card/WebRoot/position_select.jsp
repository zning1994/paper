...
-->
	...
	<body>
		<div id="right_font">
			...
			您现在所在的位置：首页  → 职务管理 → 
			<strong>职务信息查询</strong>
		</div>
		<form action="PositionSelectServlet.action?all=0" method="post">
									...
									<table width="352" height="20" border="0" cellpadding="0"
										...
										<tr>
											<td width="62" height="22" valign="middle">
												<div align="right">
													<a href="PositionSelectServlet.action?all=0&&pageNow=1"><img
											...
											<td width="50" height="22" valign="middle">
												<div align="right">
													<a
														href="PositionSelectServlet.action?all=0&&pageNow=<%=(Integer)session.getAttribute("pageNow")-1 %>"><img
											...
											<td width="49" height="22" valign="middle">
												<div align="right">
													<a
														href="PositionSelectServlet.action?all=0&&pageNow=<%=session.getAttribute("number") %>"><img
