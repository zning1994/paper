...
-->
	...
	<body>
		...
		<form action="UserSelectServlet.action?all=0" method="post">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<strong><span class="STYLE1">用户名</span>
									</strong>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<strong><span class="STYLE1">公司</span>
									</strong>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<strong><span class="STYLE1">部门</span>
									</strong>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<strong><span class="STYLE1">职务</span>
									</strong>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<strong><span class="STYLE1">邮箱</span>
									</strong>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
      ...
      for(int i=0;i<list1.size();i++){
       ...
       %>
						<tr>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE3"><%=u.getUsersName() %></span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE3"><%=company %></span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE3"><%=department %></span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE3"><%=position %></span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE3"><%=u.getEmail() %></span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">
									<span class="STYLE1"><a href="#">修改</a>
									</span>
								</div>
							</td>
							<td height="22" bgcolor="#FFFFFF">
									...
									<table width="352" height="20" border="0" cellpadding="0"
										...
										<tr>
											<td width="62" height="22" valign="middle">
												<div align="right">
													<a href="UserSelectServlet.action?all=0&&pageNow=1"><img
											...
											<td width="50" height="22" valign="middle">
												<div align="right">
													<a
														href="UserSelectServlet.action?all=0&&pageNow=<%=(Integer)session.getAttribute("pageNow")-1 %>"><img
											...
											<td width="49" height="22" valign="middle">
												<div align="right">
													<a
														href="UserSelectServlet.action?all=0&&pageNow=<%=session.getAttribute("number") %>"><img
