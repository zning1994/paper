...
-->
  ...
  <body>
   ...
   %>
   <form action="GroupInfoServlet.action?self=1&&alter=1&&groupid=<%=g.getGroupId() %>" method="post">
<table width="500" border="1" class="gridtable">
  ...
  <tr>
    ...
    <td class="STYLE1"><a href="Group_CardServlet.action?self=1&&groupId=<%=g.getGroupId() %>">查看</a></td>
  </tr>
  <tr>
