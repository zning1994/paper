...
<div align="center">
<form action="GroupAddServlet.action" method="post">
<p class="STYLE8">新建组<br />  
  </p>
<table width="600" border="1" class="gridtable" >
  <tr>
    <td width="87" class="STYLE1">组名</td>
    <td width="294"><input type="text" name="groupname" id="groupname" onblur="CheckName()"/>
    ...
    <td class="STYLE1">所在父组</td><td>
    		...
    		<%
    			GroupDao dao = new GroupDaoImpl();
    		    		 List<Groups> list = dao.find("select * from groups");
